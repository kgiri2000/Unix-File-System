...
int main()
{
  ...
  cout << "rv from createDirectory /a fs1 is " << r << (r==-1 ? " correct file /a": " fail") <<endl;
  ...
  r = c7->myFS->createDirectory(const_cast<char *>("/f"), 2);
  cout << "rv from createDirectory /f fs4 is " << r << (r==0 ? " correct": " fail") <<endl;
  ...
  cout << "rv from createFile /o/o/o/a fs2 is " << r <<(r==-1 ? " correct ": " fail") <<endl;
  r = c3->myFS->createFile(const_cast<char *>("/o/o/o/a"), 8);
  cout << "rv from createFile /o/o/o/a fs3 is " << r <<(r==-1 ? " correct ": " fail") <<endl;
  r = c3->myFS->createFile(const_cast<char *>("/o/o/o/A"), 8);
  cout << "rv from createFile /o/o/o/A fs3 is " << r <<(r==0 ? " correct ": " fail") <<endl;
  ...
  cout << "rv from deleteFile /o/o/o fs2 is " << r <<(r==-1 ? " correct":" fail")<<endl;
  r = c3->myFS->deleteFile(const_cast<char *>("/o/o/o"), 6);
  cout << "rv from deleteFile /o/o/o fs3 is " << r <<(r==-1 ? " correct":" fail")<<endl;
  ...
  cout << "rv from renameFile /o/o/o/a /o/o/o/z fs2 is " << r << (r==-2 ? " correct /o/o/o/a is dir, not file":" fail") <<endl;
  r = c5->myFS->renameDirectory(const_cast<char *>("/o/o/o/a"), 8, const_cast<char *>("/o/o/o/z"), 8);
  cout << "rv from renameDirectory /o/o/o/a /o/o/o/z fs2 is " << r << (r==0 ? " correct":" fail") <<endl;
  ...
  cout << "rv from createDirectory /o/o/o/Z fs3 is " << r << (r==0 ? " correct": " fail") <<endl;
  ...
  cout << "rv from deleteDirectory /o/o/o/Z fs3 is " << r <<(r==0 ? " correct":" fail") <<endl;

  cout <<"End of driver 6\n";
  return 0;
}
